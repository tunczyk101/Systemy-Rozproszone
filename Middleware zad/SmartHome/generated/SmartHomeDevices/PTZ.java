...
public class PTZ extends com.zeroc.Ice.Value
{
    public PTZ()
    {
    }

    public PTZ(short pan, short tilt, short zoom)
    {
        setPan(pan);
        setTilt(tilt);
        setZoom(zoom);
    ...
    /** @hidden */
    public static final long serialVersionUID = -844187880L;
