...
public interface BulbulatorPrx extends SmartDevicePrx
{
    default void bulbul()
    {
        bulbul(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void bulbul(java.util.Map<String, String> context)
    {
        _iceI_bulbulAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> bulbulAsync()
    {
        return _iceI_bulbulAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> bulbulAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_bulbulAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "bulbul", null, sync, null);
