...
public interface CameraPrx extends SmartDevicePrx
{
    default boolean takePicture()
    {
        return takePicture(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean takePicture(java.util.Map<String, String> context)
    {
        return _iceI_takePictureAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> takePictureAsync()
    {
        return _iceI_takePictureAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> takePictureAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_takePictureAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "takePicture", null, sync, null);
    ...
    {
        return startRecording(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean startRecording(java.util.Map<String, String> context)
        throws AlreadyOnError
    {
        try
        {
            return _iceI_startRecordingAsync(context, true).waitForResponseOrUserEx();
        }
        catch(AlreadyOnError ex)
        {
            throw ex;
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Boolean> startRecordingAsync()
    {
        return _iceI_startRecordingAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> startRecordingAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_startRecordingAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "startRecording", null, sync, _iceE_startRecording);
        f.invoke(true, context, null, null, istr -> {
                     boolean ret;
                     ret = istr.readBool();
                     return ret;
    ...
    {
        AlreadyOnError.class
    };

    default boolean stopRecording()
        throws AlreadyOffError
    {
        return stopRecording(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean stopRecording(java.util.Map<String, String> context)
        throws AlreadyOffError
    {
        try
        {
            return _iceI_stopRecordingAsync(context, true).waitForResponseOrUserEx();
        }
        catch(AlreadyOffError ex)
        {
            throw ex;
        }
        catch(com.zeroc.Ice.UserException ex)
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Boolean> stopRecordingAsync()
    {
        return _iceI_stopRecordingAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> stopRecordingAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_stopRecordingAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "stopRecording", null, sync, _iceE_stopRecording);
        f.invoke(true, context, null, null, istr -> {
                     boolean ret;
                     ret = istr.readBool();
                     return ret;
