...
public interface PTZCameraPrx extends CameraPrx
{
    ...
    default PTZ getPTZ(java.util.Map<String, String> context)
    {
        return _iceI_getPTZAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<PTZ> getPTZAsync()
    {
        return _iceI_getPTZAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<PTZ> getPTZAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<PTZ> _iceI_getPTZAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<PTZ> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getPTZ", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     final com.zeroc.IceInternal.Holder<PTZ> ret = new com.zeroc.IceInternal.Holder<>();
                     istr.readValue(v -> ret.value = v, PTZ.class);
    ...
    default boolean setPTZ(PTZ ptz)
        throws RangeError
    {
        return setPTZ(ptz, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean setPTZ(PTZ ptz, java.util.Map<String, String> context)
        throws RangeError
    {
        try
        {
            return _iceI_setPTZAsync(ptz, context, true).waitForResponseOrUserEx();
        }
        catch(RangeError ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Boolean> setPTZAsync(PTZ ptz)
    {
        return _iceI_setPTZAsync(ptz, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> setPTZAsync(PTZ ptz, java.util.Map<String, String> context)
    {
        return _iceI_setPTZAsync(ptz, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_setPTZAsync(PTZ iceP_ptz, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setPTZ", null, sync, _iceE_setPTZ);
