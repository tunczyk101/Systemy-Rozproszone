...
{
    default boolean bulbul()
    {
        return bulbul(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean bulbul(java.util.Map<String, String> context)
    {
        return _iceI_bulbulAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> bulbulAsync()
    {
        return _iceI_bulbulAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> bulbulAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_bulbulAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "bulbul", null, sync, null);
